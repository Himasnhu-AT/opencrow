        ...
        <>
            ...
            <div className="container">
                ...
                <div className="chat-hint">
                    ...
                    <p>Click the chat button in the bottom right to interact with your orders, subscription, and products using natural language.</p>
            ...
            {/* OpenCrow Widget */}
            <OpenCrowWidget
                productId="prod_1769500139576"
                // apiKey={OPENCROW_API_KEY}
