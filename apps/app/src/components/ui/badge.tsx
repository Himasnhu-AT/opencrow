  ...
  "inline-flex items-center rounded-md border px-2.5 py-0.5 text-xs font-semibold transition-colors focus:outline-none focus:ring-2 focus:ring-neutral-950 focus:ring-offset-2",
  {
    variants: {
      variant: {
        ...
        get: "border-transparent bg-emerald-100 text-emerald-700",
        post: "border-transparent bg-blue-100 text-blue-700",
        put: "border-transparent bg-amber-100 text-amber-700",
        delete: "border-transparent bg-red-100 text-red-700",
        patch: "border-transparent bg-purple-100 text-purple-700",
      },
    },
    defaultVariants: {
      variant: "default",
